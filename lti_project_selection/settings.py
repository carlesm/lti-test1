"""
Django settings for lti_project_selection project.

Generated for Django 5.x with LTI integration support.
"""
...
_allowed_hosts_env: str = os.environ.get("ALLOWED_HOSTS", "")
...
WSGI_APPLICATION: str = "lti_project_selection.wsgi.application"
